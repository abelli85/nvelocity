...
namespace NVelocity.Tests
{
    ...
    /// <summary> This class tests support for string concatenation.</summary>
    [TestFixture]
    public class StringConcatenationTestCase : BaseEvalTestCase
    {
        [SetUp]
        public void setUp()
        {
        ...
        [Test]
        public virtual void testStringRefLeft()
        {
        ...
        [Test]
        public virtual void testStringRefRight()
        {
