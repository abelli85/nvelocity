...
namespace NVelocity.Tests
{
    ...
    /// <summary> Used to check that nulls are properly handled in #if statements</summary>
    [TestFixture]
    public class IfNullTestCase : BaseEvalTestCase
    {
        override protected internal VelocityContext Context
        {
            set
            {
                value.Put("nullToString", new NullToString());
                value.Put("notnull", new object());
            }

        }
      
        [Test]
        public virtual void testIfEquals()
        {
            // both null
        ...
        [Test]
        public virtual void testIfNotEquals()
        {
            // both null
        ...
        [Test]
        public virtual void testIfValue()
        {
